...
void main() {
  ...
  Future<void> sendPlatformMessage(int mapId, String method, Map<dynamic, dynamic> data) async {
    ...
    await TestDefaultBinaryMessengerBinding.instance!.defaultBinaryMessenger
        .handlePlatformMessage('plugins.flutter.dev/google_maps_android_$mapId', byteData, (ByteData? data) {});
  }
  ...
  test(
    ...
    () async {
      ...
      final Widget widget = maps.buildViewWithConfiguration(1, (int _) {},
          widgetConfiguration:
              const MapWidgetConfiguration(initialCameraPosition: CameraPosition(target: LatLng(0, 0), zoom: 1), textDirection: TextDirection.ltr));
