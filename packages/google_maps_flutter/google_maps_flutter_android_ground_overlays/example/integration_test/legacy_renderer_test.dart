...
void main() {
  ...
  setUpAll(() async {
    ...
    initializedRenderer = await instance.initializeWithRenderer(AndroidMapRenderer.legacy);
  });
  ...
  testWidgets('throws PlatformException on multiple renderer initializations', (WidgetTester _) async {
    final GoogleMapsFlutterAndroid instance = GoogleMapsFlutterPlatform.instance as GoogleMapsFlutterAndroid;
    expect(() async => instance.initializeWithRenderer(AndroidMapRenderer.legacy),
        throwsA(isA<PlatformException>().having((PlatformException e) => e.code, 'code', 'Renderer already initialized')));
  });
