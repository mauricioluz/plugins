...
Downloaded by pub (not CocoaPods).
  ...
  s.documentation_url = 'https://pub.dev/packages/google_maps_flutter_ios_ground_overlays'
  s.source_files = 'Classes/**/*.{h,m}'
  s.public_header_files = 'Classes/**/*.h'
  s.module_map = 'Classes/google_maps_flutter_ios_ground_overlays.modulemap'
