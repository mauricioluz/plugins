...
class FakePlatformGoogleMap {
  ...
  Future<dynamic> onMethodCall(MethodCall call) {
    switch (call.method) {
      ...
      case 'groundOverlays#update':
        updateGroundOverlays(call.arguments as Map<dynamic, dynamic>?);
        return Future<void>.sync(() {});
      default:
        return Future<void>.sync(() {});
    }
  ...
  void updateTileOverlays(Map<String, dynamic> updateTileOverlayUpdates) {
    ...
    final List<String>? tileOverlayIdsToRemoveList = updateTileOverlayUpdates['tileOverlayIdsToRemove'] != null
        ...
        : null;
    final List<Map<dynamic, dynamic>>? tileOverlaysToChangeList = updateTileOverlayUpdates['tileOverlaysToChange'] != null
        ? List.castFrom<dynamic, Map<dynamic, dynamic>>(updateTileOverlayUpdates['tileOverlaysToChange'] as List<dynamic>)
        : null;
  ...
  void updateGroundOverlays(Map<dynamic, dynamic>? groundOverlayUpdates) {
    ...
    final List<Map<dynamic, dynamic>>? groundOverlaysToAddList = groundOverlayUpdates['groundOverlaysToAdd'] != null
        ? List.castFrom<dynamic, Map<dynamic, dynamic>>(groundOverlayUpdates['groundOverlaysToAdd'] as List<dynamic>)
        : null;
    final List<String>? groundOverlayIdsToRemoveList = groundOverlayUpdates['groundOverlayIdsToRemove'] != null
        ? List.castFrom<dynamic, String>(groundOverlayUpdates['groundOverlayIdsToRemove'] as List<dynamic>)
        : null;
    final List<Map<dynamic, dynamic>>? groundOverlaysToChangeList = groundOverlayUpdates['groundOverlaysToChange'] != null
        ? List.castFrom<dynamic, Map<dynamic, dynamic>>(groundOverlayUpdates['groundOverlaysToChange'] as List<dynamic>)
        : null;
    groundOverlaysToAdd = _deserializeGroundOverlays(groundOverlaysToAddList);
    groundOverlayIdsToRemove = _deserializeGroundOverlayIds(groundOverlayIdsToRemoveList ?? <String>[]);
    groundOverlaysToChange = _deserializeGroundOverlays(groundOverlaysToChangeList);
  }

  Set<GroundOverlayId> _deserializeGroundOverlayIds(List<String> groundOverlayIds) {
    if (groundOverlayIds == null) {
      return <GroundOverlayId>{};
    }
    return groundOverlayIds.map((String groundOverlayId) => GroundOverlayId(groundOverlayId)).toSet();
  }

  Set<GroundOverlay> _deserializeGroundOverlays(List<Map<dynamic, dynamic>>? groundOverlays) {
    ...
    for (Map<dynamic, dynamic> groundOverlayData in groundOverlays) {
      final String groundOverlayId = groundOverlayData['groundOverlayId'] as String;
      final bool visible = groundOverlayData['visible'] as bool;
  ...
  void updateOptions(Map<dynamic, dynamic> options) {
    ...
    if (options.containsKey('cameraTargetBounds')) {
      ...
      cameraTargetBounds = boundsList[0] == null ? CameraTargetBounds.unbounded : CameraTargetBounds(LatLngBounds.fromList(boundsList[0]));
    }
