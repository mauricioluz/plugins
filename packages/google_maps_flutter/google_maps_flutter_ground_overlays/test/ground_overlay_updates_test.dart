...
void main() {
  ...
  testWidgets('Initializing a ground overlay', (WidgetTester tester) async {
    ...
    final GroundOverlay initializedMarker = platformGoogleMap.groundOverlaysToAdd.first;
  ...
  testWidgets("Adding a ground overlay", (WidgetTester tester) async {
    ...
    final GroundOverlay addedGroundOverlay = platformGoogleMap.groundOverlaysToAdd.first;
  ...
  testWidgets("Removing a ground overlay", (WidgetTester tester) async {
    ...
    expect(platformGoogleMap.groundOverlayIdsToRemove.first, equals(g1.groundOverlayId));
  ...
  testWidgets("Updating a ground overlay", (WidgetTester tester) async {
    final GroundOverlay g1 = GroundOverlay(groundOverlayId: GroundOverlayId("g_overlay_1"));
    final GroundOverlay g2 = GroundOverlay(groundOverlayId: GroundOverlayId("g_overlay_1"), opacity: 0.5);
