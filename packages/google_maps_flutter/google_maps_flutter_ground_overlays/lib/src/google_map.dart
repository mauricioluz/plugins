...
part of google_maps_flutter_ground_overlays;
...
@Deprecated('See https://pub.dev/packages/google_maps_flutter_android_ground_overlays#display-mode')
...
class _GoogleMapState extends State<GoogleMap> {
  ...
  Widget build(BuildContext context) {
    return GoogleMapsFlutterPlatform.instance.buildViewWithConfiguration(_mapId, onPlatformViewCreated,
